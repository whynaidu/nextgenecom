...
export const ProductDetail = () => {
  return (
    <section className="mt-5 text-gray-600 dark:bg-white body-font overflow-hidden rounded-xl">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-500 dark:text-black tracking-widest">
              Apple
            </h2>
            <h1 className="text-gray-900 dark:text-black text-3xl title-font font-medium mb-1">
            ...
            <div className="flex mb-4">
              <span className="flex items-center">
                ...
                <span className="text-gray-600 dark:text-black ml-3">
                  4 Reviews
                </span>
              </span>
            </div>
            <p className="leading-relaxed dark:text-black">
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex">
                <span className="mr-3 dark:text-black">Color</span>
              ...
              <div className="flex items-center ml-auto dark:text-black">
...
// ProductDetail.displayName = "ProductOverviewTwo";
